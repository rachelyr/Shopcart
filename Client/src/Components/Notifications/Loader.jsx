...
export const CatLoader =() => {
    return (
        <div className='p-6 flex-colo gap-4 border border-gray-200 round-xl animate-pulse'>
...
export const CardLoader =() => {
    return (
        <div className='gap-5 animate-pulse rounded-lg p-4 flex-colo bg-white'>
            <div className='p-2 border bg-dryGray border-gray-200 rounded-lg w-full h-56 md:h-96 overflow-hidden'/>
            <span className='py-3 w-2/5 bg-dry-Gray rounded'/>
            <span className='py-2 w-2/5 bg-dry-Gray rounded'/>
        </div>
    )
};
