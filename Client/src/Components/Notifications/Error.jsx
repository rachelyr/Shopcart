...
export const Error =({text}) =>{
    return (
        <div className="my-12 flex-col flex w-full gap-2">
            <img
            src="/images/404.svg"
            alt="404"
...
export const Empty =({text}) => {
    return(
        <div className="my-12 flex-col flex items-center w-full gap-4">
            <div className="flex-col flex w-24 rounded-full h-24 text-main border border-main">
